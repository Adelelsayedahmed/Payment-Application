...
EN_terminalError_t isValidCardPAN(ST_cardData_t* cardData)
{
	...
	for (sint8_t Local_LoopIterator = Local_NumOfDigits - 1; Local_LoopIterator >= 0; Local_LoopIterator--) {
		...
		uint8_t local_CurrentDigit = cardData->primaryAccountNumber[Local_LoopIterator] - '0'; // convert the ASCII to int value
...
EN_terminalError_t getTransactionDate(ST_terminalData_t* termData)
{
	...
	printf("Use this Format DD/MM/YYYY, e.g 25/06/2022\n");
