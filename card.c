...
EN_cardError_t getCardPAN(ST_cardData_t* cardData)
{
	...
	uint8_t Local_StrLenght = 0;                                    // local variable to carry the string length used to check the input errors
...
EN_cardError_t getCardHolderName(ST_cardData_t* cardData)
{
	...
	if ((Local_StrLenght > 25) || (Local_StrLenght < 5) || (Local_StrLenght == 0))
	{
